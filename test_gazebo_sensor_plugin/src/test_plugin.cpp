...
namespace gazebo
{
  class SensorPluginTutorial : public SensorPlugin
  {
    public: SensorPluginTutorial() : SensorPlugin()
            {
              printf("Hello World!\n");
    ...
    public: void Load(sensors::SensorPtr _sensor, sdf::ElementPtr _sdf)
            {
              ...
              timer_ = this->ros_node_->create_wall_timer(1s, std::bind(&SensorPluginTutorial::publish, this));
            }
    private:
  ...
  GZ_REGISTER_SENSOR_PLUGIN(SensorPluginTutorial)
}